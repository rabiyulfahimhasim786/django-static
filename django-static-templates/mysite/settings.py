...
#STATIC_DIR  = os.path.dirname(TEMPLATE_DIR, 'static')
# Quick-start development settings - unsuitable for production

# See https://docs.djangoproject.com/en/3.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-k^p8=p0_lkiuumdmtzr0-!u_p!-z-f(xu67pxjfw!485d=b!f^'
...
#STATIC_ROOT = os.path.join(TEMPLATE_DIR, 'assets')
STATIC_URL = '/static/'
#STATICFILES_DIRS = [
